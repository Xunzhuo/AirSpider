...
`Item`的目的是定义目标网站中你需要爬取的数据，此时，爬虫的目标数据就是页面中的`Title`和`Url`，怎么提取数据，**airspider**提供了[CSS Selector](https://www.w3schools.com/cssref/css_selectors.asp)和[XPath](https://www.w3schools.com/xml/xpath_intro.asp)两种方式提取目标数据
...
这次的目的仅仅是为了演示如何使用**airspider**编写爬虫，所以这个例子仅仅爬取[Hacker News](https://news.ycombinator.com/news)的前两页数据，创建`hacker_news.py`文件：

```python
from airspider import Request, Spider
...
class HackerNewsSpider(Spider):
    ...
    async def parse(self, response):
        self.mongo_db = MotorBase().get_db('airspider_test')
...
```text
[2018-09-24 17:59:19,865]-airspider-INFO  spider : Spider started!
...
[2018-09-24 18:03:05,562]-airspider-INFO  spider : Stopping spider: airspider
[2018-09-24 18:03:05,562]-airspider-INFO  spider : Total requests: 3
[2018-09-24 18:03:05,562]-airspider-INFO  spider : Time usage: 0:00:02.802862
[2018-09-24 18:03:05,562]-airspider-INFO  spider : Spider finished!
```
...
接下来，我们将结合实例，编写一个**airspider**的第三方扩展，详见：[Plugins](./plugins.md)